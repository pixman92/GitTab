...
function makeNice(){
    ...
    for(var i=0; i<retrieved.single.length; i++){
        //required \" to make URL (a href) work!
        str+=(makeStr(['<div class="pure-u-1-3"><div class="fontSmall margMe"><div class="w3-card-2 innerPad"><div><h2>', retrieved.single[i].title, '</h2>', retrieved.single[i].date,'</div>',urlStr,'</div></div></div>']));       //critical to have all <div>(s) in correct closing, as in opening     
